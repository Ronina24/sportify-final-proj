    ...
    <div id="wrapper">
        ...
        <aside id="side-menu">
            <div id="side-menu-header">
                <a id="logo-main" href="index.php"></a>
                <div class="btn-group">
                            ...
                            <ul id="t-updates" class="mt-4">
                                ...
                                while($msg = mysqli_fetch_assoc($msgs)) {
                                    ...
                                    <div id="messageText-'.$msg["msg_id"].'" class="message"><i class="fa-solid fa-bell"></i>
                                        <textarea value="'. $msg["txt"].'" name="edit_msg" readonly="readonly" id="message-'.$msg["msg_id"].'">'. $msg["txt"].'</textarea>';
                                        if ($_SESSION["type"] == 'admin') {
                                            echo '
                                        <i class="bx bx-edit" id="edit_icon-'.$msg["msg_id"].'" onclick="edit_msg('.$msg["msg_id"].',' . $tid .')"></i>
                                        <i class="bx bx-trash"  onclick="delete_msg('.$msg["msg_id"].',' . $tid .')"></i>';}
                                        echo '
                                    </div>
